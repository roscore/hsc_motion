...
#ifndef ALICE_ACTION_MODULE_ACTION_MODULE_H_
#define ALICE_ACTION_MODULE_ACTION_MODULE_H_
...
class ActionModule : public robotis_framework::MotionModule, public robotis_framework::Singleton<ActionModule>
{
 public:
  ...
  void onModuleEnalice();
  void onModuleDisalice();
...
private:
  ...
  bool isRunningServiceCallback(alice_action_module_msgs::IsRunning::Request  &req,
                                alice_action_module_msgs::IsRunning::Response &res);

  void pageNumberCallback(const std_msgs::Int32::ConstPtr& msg);
  void startActionCallback(const alice_action_module_msgs::StartAction::ConstPtr& msg);
...
#endif /* ALICE_ACTION_MODULE_ACTION_MODULE_H_ */
