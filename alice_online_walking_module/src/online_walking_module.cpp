/*
 * alice_online_walking_module.cpp
 *
...
void OnlineWalkingModule::readIDData()
{
  ros::NodeHandle nh;
  int alice_id_int  = nh.param<int>("alice_userid",0);

  ROS_INFO("OnlineWalking id: %d",alice_id_int);
...
void OnlineWalkingModule::ftDataOutputCallback(const alice_ft_sensor_msgs::ForceTorque::ConstPtr &msg)
{
  ALICEOnlineWalking *online_walking = ALICEOnlineWalking::getInstance();
