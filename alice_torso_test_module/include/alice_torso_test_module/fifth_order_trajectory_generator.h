...
#ifndef ALICE_TORSO_TEST_MODULE_FIFTH_ORDER_TRAJECTORY_GENERATE_H_
#define ALICE_TORSO_TEST_MODULE_FIFTH_ORDER_TRAJECTORY_GENERATE_H_
...
namespace alice
{
    ...
    class FifthOrderTrajectory_

    {
    public:
        FifthOrderTrajectory_(double control_time);
        FifthOrderTrajectory_();
        ~FifthOrderTrajectory_();
