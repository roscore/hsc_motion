...
#ifndef ALICE_TORSO_TEST_MODULE_TORSO_TEST_MODULE_H_
#define ALICE_TORSO_TEST_MODULE_TORSO_TEST_MODULE_H_
...
namespace alice
{
class TorsoTestModule: public robotis_framework::MotionModule, public robotis_framework::Singleton<TorsoTestModule>
{
public:
  TorsoTestModule();
  virtual ~TorsoTestModule();
...
// publisher
  ...
  std::map<std::string, PIDController_ *> dxl_pidcontroller;
  ...
  std::map<std::string, alice::FifthOrderTrajectory_ *> motion_trajectory;
...
private:
  ...
  // manual
  float desired_manual_yaw;
  float desired_manual_pitch;

  float pre_desired_manual_yaw;
  float pre_desired_manual_pitch;

  bool manual_update;
  bool manual_init;

  // tracking
  float desired_tracking_yaw;
  float desired_tracking_pitch;

  float pre_desired_tracking_yaw;
  float pre_desired_tracking_pitch;
  ...
  double mov_time_state_manual;
  double mov_time_state_tracking;
