...
#include "alice_torso_test_module/fifth_order_trajectory_generator.h"


using namespace alice;
using namespace robotis_framework;

FifthOrderTrajectory_::FifthOrderTrajectory_(double control_time)
{
...
FifthOrderTrajectory_::FifthOrderTrajectory_()
{
    control_time_ = 0;
...
bool FifthOrderTrajectory_::detect_change_final_value(double pose_, double velocity_, double time_)
{
...
double FifthOrderTrajectory_::fifth_order_traj_gen(double initial_value_, double final_value_,
...
double FifthOrderTrajectory_::fifth_order_traj_gen_one_value(Eigen::MatrixXd joint_)
{
