                                          ...
                                          std::string offset_file_path)
{
  ...
  //Action File Check
  std::string path = ros::package::getPath("alice_action_module") + "/data/motion_4095.bin";
...
//  }
  ...
  default_editor_script_path_ = ros::package::getPath("alice_action_editor") + "/config/editor_script.yaml";
  mirror_joint_file_path_ = ros::package::getPath("alice_action_editor") + "/config/config_mirror_joint.yaml";
